...
function validateCI(ci) {
  ...
  var lastDigit = parseInt(ci[9], 10);
  var checksum = (total % 10 === 0) ? 0 : 10 - (total % 10);
...
function validateRUC(ruc) {
  ...
  var ciValidation = validateCI(ci);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  correoInput.addEventListener('blur', function () {
    ...
    validationMessageElement.textContent = validationMessage;
    validationMessageElement.style.color = validationMessage.includes('válido') ? 'green' : 'red';
  });
