...
// Funci髇 para resetear y ocultar formularios
function resetForm() {
...
document.getElementById('search-button').addEventListener('click', async () => {
  ...
  try {
      ...
      if (response.ok && data) {
          ...
          // Muestra el formulario de actualizaci贸n
          document.getElementById('update-form').classList.remove('hidden');
      } else {
          alert('No se encontr贸 ning煤n registro con ese Documento de Identidad.');
      }
  } catch (error) {
      console.error('Error:', error);
      alert('Ocurri贸 un error al buscar el registro.');
  }
});
...
document.getElementById('guardar').addEventListener('click', async () => {
  ...
  try {
      ...
      console.error('Error:', error);
      alert('Ocurri贸 un error al actualizar el registro.');
  }
});
